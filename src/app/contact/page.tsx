          ...
          <div className="mt-12 max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <AnimateIn type="fadeUp">
              <div className="group bg-background-paper rounded-xl shadow-brand border border-border-light p-6 h-full transition-all duration-300 hover:shadow-brand-lg hover:-translate-y-1">
                <div className="w-12 h-12 rounded-xl bg-primary/5 flex items-center justify-center mb-4 group-hover:bg-gradient-to-br group-hover:from-gold group-hover:to-gold-500 transition-all duration-300">
                  <svg className="w-6 h-6 text-primary/50 group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.4}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                  </svg>
                </div>
                <h3 className="text-base font-heading font-bold text-primary mb-2">Address</h3>
            ...
            <AnimateIn type="fadeUp" delay={0.05}>
              <div className="group bg-background-paper rounded-xl shadow-brand border border-border-light p-6 h-full transition-all duration-300 hover:shadow-brand-lg hover:-translate-y-1">
                ...
                <h3 className="text-base font-heading font-bold text-primary mb-2">Email</h3>
                <p className="text-sm text-foreground-muted">techmanagement@university.edu</p>
              </div>
            </AnimateIn>
            ...
            <AnimateIn type="fadeUp" delay={0.1}>
              <div className="group bg-background-paper rounded-xl shadow-brand border border-border-light p-6 h-full transition-all duration-300 hover:shadow-brand-lg hover:-translate-y-1">
                ...
                <h3 className="text-base font-heading font-bold text-primary mb-2">Phone</h3>
                <p className="text-sm text-foreground-muted">+1 (555) 123-4500</p>
              </div>
            </AnimateIn>
            ...
            <AnimateIn type="fadeUp" delay={0.15}>
              <div className="group bg-background-paper rounded-xl shadow-brand border border-border-light p-6 h-full transition-all duration-300 hover:shadow-brand-lg hover:-translate-y-1">
                ...
                <h3 className="text-base font-heading font-bold text-primary mb-2">Office Hours</h3>
                <p className="text-sm text-foreground-muted">Monday - Friday</p>
                <p className="text-sm text-foreground-muted">9:00 AM - 5:00 PM</p>
              </div>
            </AnimateIn>
          </div>
        </div>
