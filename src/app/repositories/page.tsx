            ...
            <div className="container-site">
              ...
              <StaggerGroup className="space-y-4">
                {forms.map((form) => (
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center p-6 gap-5">
                      {/* Icon */}
                      <div className="w-14 h-14 rounded-xl bg-accent/5 flex items-center justify-center flex-shrink-0 group-hover:bg-accent/10 transition-colors">
      ...
      <section className="section-padding bg-background">
        <div className="container-site">
          <AnimateIn type="fadeUp" className="section-heading">
            <p className="text-base font-semibold uppercase tracking-[0.2em] text-gold mb-3">Important</p>
            <h2 className="text-3xl md:text-4xl">Submission Guidelines</h2>
          ...
          <div className="mt-12 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <AnimateIn key={guide.title} type="fadeUp">
                <div className="bg-background-paper rounded-2xl shadow-brand border border-border-light p-8 h-full">
                  <h3 className="text-lg font-heading font-bold text-primary mb-4">{guide.title}</h3>
      ...
      <section className="relative py-24 bg-primary overflow-hidden">
        ...
        <div className="container-site relative z-10 text-center">
          <AnimateIn type="scaleIn">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-gold mb-4">Need Help?</p>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-white mb-4">Having trouble with a form?</h2>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="/contact" className="btn-accent px-8 py-3 text-base">Contact Us</a>
              <a href="mailto:admin@university.edu" className="inline-flex items-center gap-2 bg-white/10 text-white px-8 py-3 rounded-xl text-base font-semibold hover:bg-white/20 transition-colors backdrop-blur-sm">
