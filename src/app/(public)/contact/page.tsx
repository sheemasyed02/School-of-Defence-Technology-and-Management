              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 bg-background-paper rounded-2xl shadow-brand-lg border border-border-light overflow-hidden">
                  ...
                  <form onSubmit={handleSubmit} className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5">
                    {success && (
                      <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-100 rounded-lg text-green-800 animate-in fade-in duration-500">
                    ...
                    {error && (
                      <div className="flex items-center gap-3 p-4 bg-red-50 border border-red-100 rounded-lg text-red-800 animate-in fade-in duration-500">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      ...
                      <div className="hidden">
                        ...
                        <input
                          ...
                          autoComplete="off"
                          tabIndex={-1}
                          value={(formData as any).hp_field || ""}
                          onChange={(e) => setFormData({ ...formData, hp_field: e.target.value } as any)}
                        />
                      </div>
                      <div>
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="inline-flex items-center justify-center gap-2 btn-primary text-base px-8 py-3 w-full sm:w-auto disabled:opacity-70 disabled:cursor-not-allowed group transition-all"
                      >
                        {loading ? (
                          <>
