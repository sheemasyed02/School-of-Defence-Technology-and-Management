...
export default async function ResearchPage() {
  ...
  const formatYear = (dateStr: string) => {
      try {
          ...
          return "N/A"; // Or a default year like "2024" if preferred
      }
  };
                ...
                <div className="group bg-background-paper rounded-2xl shadow-brand border border-border-light overflow-hidden transition-all duration-300 hover:shadow-brand-lg hover:-translate-y-0.5">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="md:w-48 lg:w-56 bg-gradient-to-br from-primary to-secondary p-4 sm:p-5 md:p-6 flex flex-row md:flex-col items-center justify-center text-center shrink-0 gap-3 md:gap-0">
                      ...
                      <p className="text-sm font-heading font-bold text-white">{formatDuration(proj.startDate, proj.endDate)}</p>
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-xs text-white/80">{proj.authors}</span>
                      </div>
                    </div>
                    {/* Content */}
                    <div className="p-4 sm:p-5 md:p-6 flex-1 flex flex-col justify-center">
                      ...
                      <p className="text-xs sm:text-sm text-foreground-muted leading-relaxed">{proj.abstract}</p>
                    </div>
                  </div>
                </div>
              </AnimateIn>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-block rounded-full bg-gold/10 px-2.5 py-0.5 text-[10px] font-bold text-gold">{formatYear(pub.publicationDate)}</span>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-2 mb-1.5">
                    ...
                    <span className="inline-block rounded-full bg-gold/10 px-2 py-0.5 text-[10px] font-bold text-gold">{formatYear(pat.publicationDate)}</span>
                  </div>
